...
from .views import getData24h, userSensorsActual, updateSensorsGroup, getDevices, getAddDeviceToken, getSingleDevice, updateDeviceConfig, getDeviceList, updateMeasureGroups, deleteDevices
