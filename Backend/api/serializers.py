...
from EspServer.models import SensorData, Sensor, Device, AddDeviceToken, MeasurementsGroup, CustomUser
...
class UserLoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if user and user.is_active:
            return user
        raise serializers.ValidationError("Nieprawidlowe dane logowania")
