...
const LiveView = () => {
  ...
  const SensorCard = ({ data }) => (
    ...
    >
      ...
      <span className='block text-center text-gray-300 mt-20 font-["Tourney"] text-8xl'>{data.value}</span>
      <span className={`block text-center text-gray-400 mt-20 text-3xl ${data.online ? "text-green-600" : "text-red-900"}`}>
  ...
  const SensorGroup = ({ group }) => (
    <div>
      <h2 className='text-gray-300 text-3xl font-bold my-10 w-full text-center bg-gray-700'>{group}</h2>
  ...
  return (
    <div className='w-full h-auto'>
      <div className='flex flex-col justify-center px-20 mt-10'>
        <div className='flex flex-col bg-gray-800 rounded-xl my-10 px-10'>
            ...
            {groupMode &&
              <div>
                ...
                <input type="text"
                  ...
                  className='block bg-gray-400 text-gray-700 mb-3 rounded-sm h-10 px-2'
