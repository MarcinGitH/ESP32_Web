...
const handleAddGroup = ()=>{
  ...
  setAllGroupList(prev=>[...prev,{id:next_minus_id,name:""}])
}
            ...
            <div className='overflow-y-auto max-h-100'>
              {!serverConnectOk ?
                ...
                : !devicesList.length ?
                  ...
                  :
                  <div className=' px-3 py-2 border-2 border-gray-500 rounded-3xl'>
                    {devicesList.map((device, id) => (
                      <div key={id}
                        className='flex flex-col lg:flex-row items-center gap-4 bg-gray-700 px-10 my-5 py-5 rounded-2xl cursor-pointer hover:bg-gray-600'
                        ...
                        <div className='flex-1'>
                          <p className='text-gray-300 text-xl text-center'>Status: {device.online ? <span className='text-green-600 text-xl'>Online</span> : <span className='text-gray-400 text-xl'>Offline</span>}</p>
                        </div>
                      </div>
                    ))}
                  </div>}
              ...
              {!serverConnectOk ?
                ...
                : !allGroupList.length ?
                  ...
                  <div>
                    ...
                    <div className=' px-3 py-2 border-2 border-gray-500 rounded-3xl overflow-y-auto overflow-x-hidden max-h-100'>
                      {allGroupList.map((group) => (
                        ...
                        <div key={group.id}
                          ...
                          <div className={`flex justify-between items-center absolute top-1/2 -translate-y-1/2 bg-gray-500 rounded-md border-2 border-gray-400 transition-all duration-200
                            ...
                            <p className='text-center text-gray-300 px-5 py-3'>Czy usunąć grupę?</p>
